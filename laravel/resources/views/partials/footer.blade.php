        ...
        <script language="JavaScript" src="{{ myUrl('/front-end/controllers/home.controller.js') }}"></script>
        <script language="JavaScript" src="{{ myUrl('/front-end/controllers/client.controller.js') }}"></script>
        <script language="JavaScript" src="{{ myUrl('/front-end/controllers/company.controller.js') }}"></script>
        <script language="JavaScript" src="{{ myUrl('/front-end/controllers/deliveryman.controller.js') }}"></script>
        ...
        <script language="JavaScript" src="{{ myUrl('/front-end/services/deliveryman.service.js') }}"></script>
